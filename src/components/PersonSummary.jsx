  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        {myItems.map(it => (
          <div key={it.id} className="bg-white p-4 rounded-3xl shadow-sm border border-slate-100 flex justify-between items-center">
            <span className="font-bold text-slate-700 text-sm truncate pr-2">{it.name}</span>
        ...
        <div className="bg-slate-100/50 p-4 rounded-3xl border border-slate-100 flex justify-between items-center">
